...
void TLC59116_Setup() {
    TLC59116_WriteReg(TLC59116_ALLCALLADDR, MODE1, AUTOINC_ALL | 0x11);
    TLC59116_WriteReg(TLC59116_ALLCALLADDR, MODE2, 0x04);
}

void TLC59116_On() {
    // Set Mode1 to 0x11 to turn on the Oscilator
    TLC59116_WriteReg(TLC59116_ALLCALLADDR, MODE1, AUTOINC_ALL | 0x11);
}
